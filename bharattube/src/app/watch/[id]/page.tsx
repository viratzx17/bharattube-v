...
export default function WatchPage({
  ...
  const fetchWatchData = useCallback(async () => {
    ...
    try {
      ...
      const userReaction =
        currentUserId && Array.isArray(rawVideo?.likes) &&
        rawVideo.likes.some((like: any) => String(like?._id ?? like) === currentUserId)
          ? "like"
          : currentUserId && Array.isArray(rawVideo?.dislikes) &&
            rawVideo.dislikes.some((dislike: any) => String(dislike?._id ?? dislike) === currentUserId)
          ? "dislike"
          : null;
