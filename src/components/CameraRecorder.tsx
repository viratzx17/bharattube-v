      ...
      <div className="shrink-0 pb-safe px-6 py-5 flex items-center justify-center gap-6">
        {status === "ready" && (
          ...
          <button
            ...
            aria-label="Choose a video from gallery"
            className="w-12 h-12 rounded-full bg-zinc-900/80 text-white border border-zinc-700 flex items-center justify-center active:scale-95"
          >
