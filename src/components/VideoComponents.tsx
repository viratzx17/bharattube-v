...
export function LikeDislikePill({
    ...
    try {
      ...
      if (res.ok && (
        ...
        onReactionChange(
          ...
          Number(data.dislikesCount ?? data.dislikes ?? 0),
          removing ? null : type
        );
  ...
  return (
    <div className="inline-flex shrink-0 items-center rounded-full bg-zinc-200/80 dark:bg-zinc-800/90 border border-zinc-300/60 dark:border-zinc-700/70 overflow-hidden min-h-11">
      <button
        type="button"
