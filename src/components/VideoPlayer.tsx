...
export function VideoPlayer({
  ...
  useEffect(() => {
    ...
    const url = URL.createObjectURL(new Blob([captionsVtt], { type: "text/vtt;charset=utf-8" }));
    setCaptionSrc(url);
        ...
        <div className="flex items-center justify-between gap-2 text-white">
          ...
          <div className="flex items-center gap-1.5 relative">
            ...
            <button
              ...
              onClick={() => {
                if (!captionsVtt) {
                  showToast("No captions are available for this video.", "info");
                  return;
                }
